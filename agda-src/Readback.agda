...
rb-ty (sb σ pi[ μ ] A , B) = (Π "_" :[ rb-sb μ ] rb-ty A , rb-ty B) [ rb-sb σ ]
rb-ty sb σ univ = univ [ rb-sb σ ]
rb-ty (el' t) = rb-neu t

rb-val (neu a) = rb-neu a
rb-val (sb_lam_ {μ = μ} {A = A} σ body) = (lam "_" :[ rb-sb μ ] rb-ty A , rb-val body) [ rb-sb σ ]
...
rb-sb ε = ε
rb-sb {Δ = Δ ,[ μ ] A} (_,_ σ a) = rb-sb σ , "_" :[ rb-sb μ ] rb-ty A := rb-val a
